            ...
            <div class="container-fluid">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" name="terbit_spp" id="terbit_spp" class="form-control" value="<?php echo htmlspecialchars($data['terbit_spp']); ?>">
                    </div>
                    <div class="col-md-6">
                        <label for="batas_bayar" class="form-label">Batas Bayar:</label>
                        <input type="date" name="batas_bayar" id="batas_bayar" class="form-control" value="<?php echo htmlspecialchars($data['batas_bayar']); ?>">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" name="awal_periode_bhp" id="awal_periode_bhp" class="form-control" value="<?php echo htmlspecialchars($data['awal_periode_bhp']); ?>">
                    </div>
                    <div class="col-md-6">
                        <label for="potensi_bhp" class="form-label">Potensi BHP:</label>
                        <input type="text" name="potensi_bhp" id="potensi_bhp" class="form-control"
                            value="Rp <?php echo number_format($data['potensi_bhp'], 0, ',', '.'); ?>"
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="besar_bhp" id="besar_bhp" class="form-control"
                            value="Rp <?php echo number_format($data['besar_bhp'], 0, ',', '.'); ?>"
                            oninput="formatRupiah(this)">
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" name="tgl_pembayaran" id="tgl_pembayaran" class="form-control" value="<?php echo htmlspecialchars($data['tgl_pembayaran']); ?>">
                    </div>
                    <div class="col-md-6">
                    <label for="bhp_terbayar" class="form-label">BHP Terbayar:</label>
                        <input type="text" name="bhp_terbayar" id="bhp_terbayar" class="form-control"
                            value="Rp <?php echo number_format($data['bhp_terbayar'], 0, ',', '.'); ?>"
                            oninput="formatRupiah(this)">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <label for="bhp_dibatalkan" class="form-label">BHP Dibatalkan:</label>
                        <input type="text" name="bhp_dibatalkan" id="bhp_dibatalkan" class="form-control"
                            value="Rp <?php echo number_format($data['bhp_dibatalkan'], 0, ',', '.'); ?>"
                            oninput="formatRupiah(this)">
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="text" name="denda_tunggakan" id="denda_tunggakan" class="form-control"
                            value="Rp <?php echo number_format($data['denda_tunggakan'], 0, ',', '.'); ?>"
                            oninput="formatRupiah(this)">
                    </div>
                </div>
